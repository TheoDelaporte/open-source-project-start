...
We use [GitHub Issues](https://github.com/theoDelaporte/open-source-project-start/issues) to track all tasks related to this project.

To help you get your feet wet and get you familiar with our contribution process, we have [a list of friendly issues](https://github.com/theoDelaporte/open-source-project-start/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) that contain tasks which are fairly easy to fix. This is a great place to get started.
...
1. Find the [New Pull Request](https://github.com/theoDelaporte/open-source-project-start/compare/) button
